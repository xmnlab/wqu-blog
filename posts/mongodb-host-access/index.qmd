...
Use the actual MongoDB IP address from your platform pop-up, not the example above. If you want more background on what IP addresses are, see the [Wikipedia page about IP addresses](https://en.wikipedia.org/wiki/IP_address).
